...
export const getAll = async (req, res, next) => {
    ...
    try {
        ...
        return ApiResponse.success(races, "Races retrieved successfully").send(
            res
        );
    } catch (error) {
        next(error);
...
export const getRaceById = async (req, res, next) => {
    ...
    try {
        ...
        return ApiResponse.success(race, "Race retrieved successfully").send(
            res
        );
    } catch (error) {
        next(error);
            ...
            switch (result.error) {
                case "DRIVER_NOT_FOUND":
                    throw ApiError.notFound(
                        `Driver ${result.driver} not found.`
                    );
                default:
                    throw ApiError.internal("Internal server error.");
            }
        }
        return ApiResponse.created(result, "Race created successfully").send(
            res
        );
    } catch (error) {
        next(error);
...
export const updateRaceMode = async (req, res, next) => {
    ...
    logger.info(
        `RaceController.updateRaceMode(raceId:${raceId}, mode:${mode})`
    );
...
export const startCurrentRace = async (req, res, next) => {
    ...
    try {
        ...
        return ApiResponse.success(result, "Race started successfully").send(
            res
        );
    } catch (err) {
        next(err);
...
export const deleteRace = async (req, res, next) => {
    ...
    try {
        ...
        return ApiResponse.noContent(result, "Race deleted successfully").send(
            res
        );
    } catch (error) {
        next(error);
